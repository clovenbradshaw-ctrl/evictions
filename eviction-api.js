 ...
 * and returns raw rows. Deduplication is handled downstream
 * by the UI layer after normalizeRecord.
 *
 * stateData extraction is deferred for now.
 */
const EvictionAPI = (function () {
  ...
  // ---------------------------------------------------------------------------
  // Public: fetch all pages, return raw rows
  // ---------------------------------------------------------------------------
